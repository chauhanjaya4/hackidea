...
<section className="all_post section_padding" id="about">
...
<section className="all_post section_padding" id="posts">
...
<section className="social_connect_part" id="whatsnew">
  <h3>What's New</h3> 
<div className="container-fluid">
<div className="row">
